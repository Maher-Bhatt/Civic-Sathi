...
import { C as Building2, b as CircleCheck, l as Search, r as TriangleAlert, s as ShieldAlert } from "../_libs/lucide-react.mjs";
import { b as verifyContractor, g as suspendContractor, l as getContractors, r as useAdminAuth, y as useI18n } from "./router-B101IEkm.mjs";
import { t as GlassCard } from "./glass-card-CoNgXAty.mjs";
import { n as LoadingState } from "./states-BSypa5q_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/contractors-tS0OEC5G.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					children: t("ui.contractor_registry")
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-[var(--muted-foreground)]",
					children: t("ui.manage_and_verify_platform_con")
				})] })
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [filtered.map((contractor) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									...
									children: [t("ui.reg"), contractor.registrationNumber]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: t("ui.no_contractors_found_matching_")
				})]
			})
		]
	});
...
function StatusBadge({ status }) {
	...
	if (status === "PENDING_VERIFICATION") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TriangleAlert, { className: "w-3 h-3" }),
			" ",
			t("ui.pending")
		]
	});
	if (status === "SUSPENDED") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldAlert, { className: "w-3 h-3" }),
			" ",
			t("ui.suspended")
		]
	});
