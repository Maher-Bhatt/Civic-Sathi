...
import { a as getAuditLogs, c as getContractors, i as getAllEvidence, u as getWorkOrders } from "./router-CYRUKuqz.mjs";
import { n as SectionLabel, t as GlassCard } from "./glass-card-CoNgXAty.mjs";
import { _ as CircleAlert, a as Shield, g as CircleCheck, h as ClipboardList, i as Timer, o as ShieldAlert, v as Building2, x as Activity } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/dashboard-642fsAqZ.js
...
function AdminDashboardContent() {
	...
	const highRiskContractors = contractors.filter((c) => c.performanceScore !== void 0 && c.performanceScore < 60).length;
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, {
						title: "High Risk Cont.",
						value: highRiskContractors,
						icon: ShieldAlert,
						alert: highRiskContractors > 0
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, {
						title: "Active Work",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, {
						...
						value: evidenceHealthRate,
						suffix: "%",
						icon: Activity,
						alert: evidenceHealthRate < 90
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function StatCard({ title, value, suffix = "", icon: Icon, alert }) {
