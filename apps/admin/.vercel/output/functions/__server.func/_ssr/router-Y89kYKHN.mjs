...
//#region node_modules/.nitro/vite/services/ssr/assets/i18n-BV7D9SnL.js
...
function getCachedPlatformStats() {
...
async function listAllUsers(filters) {
	...
	try {
		const res = await adminApiFetch(`/api/v1/admin/users?${params.toString()}`);
		if (res && Array.isArray(res) && typeof window !== "undefined") localStorage.setItem("janmind_admin_users", JSON.stringify(res));
		return res;
	} catch (e) {
...
async function getPlatformStats() {
	try {
		const stats = await adminApiFetch("/api/v1/admin/stats");
		if (stats && typeof window !== "undefined") localStorage.setItem("janmind_admin_stats", JSON.stringify(stats));
		return stats;
	} catch (e) {
...
async function createRealContractor(data) {
	return adminApiFetch("/api/v1/admin/contractors", {
		method: "POST",
		body: JSON.stringify(data)
	});
}
...
async function listRealWorkOrders() {
	try {
		const wos = await adminApiFetch("/api/v1/admin/work-orders");
		if (wos && typeof window !== "undefined") localStorage.setItem("janmind_admin_work_orders", JSON.stringify(wos));
		return wos;
	} catch (e) {
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-Y89kYKHN.js
...
var styles_default = "/assets/styles-c0wvDzuT.css";
	...
	head: () => ({
		meta: [
			...
			},
			{
				...
				content: "JANMIND Admin"
			},
			{ title: "JANMIND — Super Admin Platform" },
			{
				name: "description",
				content: "City-wide civic governance, contractor vetting, and SLA analytics administration."
			},
			{
				name: "author",
				content: "JANMIND"
			...
			{
				property: "og:title",
				content: "JANMIND — Super Admin Platform"
			},
			{
				property: "og:description",
				content: "Platform governance and cross-city analytics."
			},
			{
				property: "og:type",
				content: "website"
...
//#endregion
export { verifyContractor as C, useI18n as S, listAllUsers as _, createUser as a, updateSLARule as b, getCachedPlatformStats as c, getContractorDocuments as d, getContractors as f, listAdminCities as g, getWorkOrders as h, createRealContractor as i, getCachedWorkOrders as l, getSLARules as m, Route as n, deleteUser as o, getPlatformStats as p, useAdminAuth as r, getAuditLogs as s, router_exports as t, getContractor as u, listRealWorkOrders as v, updateUser as x, suspendContractor as y };
