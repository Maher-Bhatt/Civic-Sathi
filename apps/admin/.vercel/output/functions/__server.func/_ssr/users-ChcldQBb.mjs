...
import { C as Check, d as Plus, f as Pen, i as Trash2, l as Search, n as Users, t as X } from "../_libs/lucide-react.mjs";
import { S as useI18n, _ as listAllUsers, a as createUser, g as listAdminCities, o as deleteUser, x as updateUser } from "./router-Y89kYKHN.mjs";
import { n as SectionLabel, t as GlassCard } from "./glass-card-CoNgXAty.mjs";
import { n as LoadingState } from "./states-BSypa5q_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/users-ChcldQBb.js
...
function UserManagementPage() {
	...
	const [loading, setLoading] = (0, import_react.useState)(() => {
		if (typeof window !== "undefined" && localStorage.getItem("janmind_admin_users")) return false;
		return true;
	});
	...
	const load = async () => {
		try {
			...
			if (users.length === 0) toast.error(e.message ?? "Failed to load users");
		} finally {
			setLoading(false);
		}
	};
