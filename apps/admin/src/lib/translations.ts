...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    "ui.civicsathi_has_detected_existing_": "Civic Sathi has detected existing ",
    "ui.m_away": "M away",
  ...
  hi: {
    ...
    "ui.civicsathi_municipal_intelligence": "[HI] Civic Sathi Municipal Intelligence Platform",
    "ui.officer_id_email": "[HI] Officer ID / Email",
    "ui.officer_vmc_gov_in": "[HI] officer@vmc.gov.in",
    "ui.password": "पासवर्ड",
    "ui.civicsathi_copilot": "[HI] Civic Sathi Copilot",
    ...
    "ui.why_civicsathi_flagged_this": "[HI] Why Civic Sathi Flagged This",
    ...
    "ui.civicsathi_prototype_risk_score": "[HI] Civic Sathi Prototype Risk Score",
    ...
    "ui.review_incoming_complaints_fla": "[HI] Review incoming complaints flagged by Civic Sathi AI as potentially related to existing civic issues.",
    ...
    "ui.patterns_civicsathi_has_detected": "[HI] Patterns Civic Sathi has detected",
    ...
    "ui.civicsathi_civic_infrastructure_p": "[HI] Civic Sathi Civic Infrastructure Platform",
    ...
    "home.hero.desc":
      "स्थान और साक्ष्य के साथ नागरिक समस्याओं की रिपोर्ट करें। Civic Sathi व्यक्तिगत शिकायतों को बड़े पैटर्न से जोड़ने में मदद करता है।",
    "home.hero.howitworks": "यह कैसे काम करता है",
    "home.hero.smallprint":
      "लगभग एक मिनट लगता है। आपको विभाग या श्रेणी जानने की ज़रूरत नहीं — Civic Sathi आपके लिए सुझाव देता है।",
    ...
    "pattern.desc":
      "जब कई नागरिक पास में एक जैसी समस्या बताते हैं, तो Civic Sathi उन्हें एक समूह में जोड़ता है — किसी की पहचान या पता उजागर किए बिना।",
    ...
    "login.new": "Civic Sathi पर नए हैं?",
    ...
    "ui.designation": "पद का नाम",
    "ui.close_report_details": "रिपोर्ट विवरण बंद करें",
    "ui.similar_reports_within_approxi": "लगभग 500 मीटर के भीतर इसी तरह की रिपोर्टें",
    "ui.related_reports": "संबंधित रिपोर्ट",
    "ui.aggregate_view_only_no_citizen": "केवल समग्र दृश्य - कोई नागरिक पहचान साझा नहीं की जाती है।",
    "ui.report_this_too": "मुझे भी इसका अनुभव है",
    "ui.current": "मौजूदा",
    "ui.why_we_ask_for_location": "हम स्थान क्यों पूछते हैं",
    "ui.your_location_helps_us_underst": "आपका स्थान हमें स्थानीय नागरिक पैटर्न को समझने और व्यक्तिगत ट्रैकिंग डेटा संग्रहीत किए बिना संबंधित रिपोर्टों को जोड़ने में मदद करता है।",
    "ui.use_my_current_location": "मेरे वर्तमान स्थान का उपयोग करें",
    "ui.choose_on_map": "मानचित्र पर चुनें",
    "ui.waiting_for_your_device_locati": "आपके डिवाइस स्थान की प्रतीक्षा की जा रही है...",
    "ui.we_couldn_t_read_your_device_l": "हम आपके डिवाइस का स्थान नहीं पढ़ सके. कृपया मानचित्र पर अपना स्थान चुनें.",
    "ui.location_detected": "स्थान का पता लगाया गया",
    "ui.tap_the_map_or_drag_the_marker": "सटीक समस्या स्थान सेट करने के लिए मानचित्र पर टैप करें या मार्कर को खींचें।",
    "ui.add_a_photo_of_the_problem": "समस्या का फ़ोटो जोड़ें",
    "ui.optional_a_photo_helps_the_dep": "वैकल्पिक रूप से एक फोटो विभाग की मदद करता है",
    "ui.camera": "कैमरा",
    "ui.gallery": "गैलरी",
    "ui.replace": "प्रतिस्थापित करें",
    "ui.remove": "निकालना",
    "ui.ai_assisted_image_reading": "एआई-सहायता प्राप्त छवि पढ़ना",
    "ui.detected": "पता चला:",
    "ui.suggested_category": "सुझाई गई श्रेणी:",
    "ui.this_is_an_ai_assisted_suggest": "यह आपकी फोटो पर आधारित AI-सहायता प्राप्त सुझाव है। आप इसकी पुष्टि कर सकते हैं या इसे बदल सकते हैं.",
    "ui.confirm": "पुष्टि करना",
    "ui.change_category": "श्रेणी बदलें",
    "ui.primary": "प्राथमिक",
    "ui.mobile": "गतिमान",
    "ui.voice_input_not_supported_in_t": "टी में वॉयस इनपुट समर्थित नहीं है",
    "ui.listening": "सुनना",
    "ui.processing": "प्रसंस्करण",
    "ui.describe_by_voice": "आवाज से वर्णन करें",
    "ui.we_couldn_t_analyze_your_repor": "हम आपकी रिपोर्ट का विश्लेषण नहीं कर सके",
    "ui.wait_a_moment": "एक पल इंतज़ार करें",
    "ui.similar_issues_found_nearby": "इसी तरह के मुद्दे आस-पास पाए गए",
    "ui.civicsathi_has_detected_existing_": "सिविकसाथी ने मौजूदा का पता लगाया है",
    "ui.m_away": "एम दूर",
    "ui.other_reports": "अन्य रिपोर्ट",
    "ui.yes_i_m_also_affected": "हां मैं भी प्रभावित हूं",
    "ui.is_your_issue_completely_diffe": "क्या आपका मामला बिल्कुल अलग है",
    "ui.no_report_as_a_new_issue": "नए मुद्दे के रूप में कोई रिपोर्ट नहीं",
    "ui.your_report": "आपकी रिपोर्ट",
    "ui.analysis_complete": "विश्लेषण पूरा हुआ",
    "ui.ai_suggested_category": "ऐ सुझाई गई श्रेणी",
    "ui.complaint_received": "शिकायत मिली",
    "ui.your_report_is_now_on_record_a": "आपकी रिपोर्ट अब रिकॉर्ड पर है",
    "ui.track_complaint": "शिकायत ट्रैक करें",
    "ui.civicsathi_intelligence": "सिविकसाथी इंटेलिजेंस",
    "ui.analyzing_your_report": "आपकी रिपोर्ट का विश्लेषण",
    "ui.my_complaints": "मेरी शिकायतें",
    "ui.submitted": "प्रस्तुत किया गया",
    "ui.work_execution_status": "कार्य निष्पादन की स्थिति",
    "ui.work_progress": "कार्य प्रगति",
    "ui.inspection_passed_work_quality": "निरीक्षण में कार्य की गुणवत्ता सही पाई गई",
    "ui.nearby_civic_activity": "आस-पास की नागरिक गतिविधि",
    "ui.similar_reports_within_500m": "500 मीटर के भीतर इसी तरह की रिपोर्ट",
    "ui.timeline": "समय",
    "ui.your_activity": "आपकी गतिविधि",
    "ui.every_report_you_submit_stays_": "आपके द्वारा सबमिट की गई प्रत्येक रिपोर्ट कायम रहती है",
    "ui.no_reports_yet": "अभी तक कोई रिपोर्ट नहीं",
    "ui.public_civic_intelligence": "पब्लिक सिविक इंटेलिजेंस",
    "ui.by_locality_coloured_by_aggreg": "स्थानीयता से, समग्र गंभीरता से रंगा हुआ",
    "ui.localities": "जनपद",
    "ui.map_mode": "मानचित्र मोड",
    "ui.search_area_or_locality": "क्षेत्र या इलाका खोजें...",
    "ui.near_me": "मेरे पास",
    "ui.reset": "रीसेट करें",
    "ui.all_issues": "सभी मुद्दे",
    "ui.any_severity": "कोई भी गंभीरता",
    "ui.no_data_under_current_filters": "वर्तमान फ़िल्टर के अंतर्गत कोई डेटा नहीं.",
    "ui.shaded_polygons_are_an_approxi": "छायांकित क्षेत्र एक अनुमानित स्थानिक एकत्रीकरण हैं।",
    "ui.aggregate_view_only_no_names_c": "केवल समग्र दृश्य - कोई नाम, संपर्क जानकारी या निजी विवरण प्रदर्शित नहीं होते हैं।",
    "ui.no_hotspots_under_the_current_": "वर्तमान फ़िल्टर के अंतर्गत कोई हॉटस्पॉट नहीं मिला।",
    "ui.civic_activity": "नागरिक गतिविधि",
    "ui.close_area_details": "क्षेत्र विवरण बंद करें",
    "ui.top_issue": "शीर्ष अंक",
    "ui.recent_activity": "हाल की गतिविधि",
    "ui.reported": "रिपोर्ट किया गया",
    "ui.no_reports_under_these_filters": "इन फ़िल्टर के अंतर्गत कोई रिपोर्ट नहीं मिली.",
    "ui.approximate_civic_activity_are": "अनुमानित नागरिक गतिविधि क्षेत्र",
    "ui.report_an_issue_here": "यहां किसी समस्या की रिपोर्ट करें",
    "ui.view_complaints": "शिकायतें देखें",
    "ui.unread": "अपठित ग",
    "ui.updates": "अपडेट",
    "ui.nothing_yet": "अभी तक कुछ भी नहीं",
    "auth.sign_in": "दाखिल करना",
    "ui.preferred_ward": "पसंदीदा वार्ड",
    "ui.notification_settings": "अधिसूचना सेटिंग्स",
    "ui.status_updates_on_my_complaint": "मेरी शिकायतों पर स्थिति अद्यतन",
    "ui.nearby_civic_patterns_in_my_wa": "मेरे वार्ड में निकटवर्ती नागरिक पैटर्न",
    "ui.change_password": "पासवर्ड बदलें",
    "ui.log_out": "लॉग आउट",
    "ui.new_report": "नई रिपोर्ट",
    "ui.tell_civicsathi_what_happened": "सिविकसाथी को बताएं कि क्या हुआ",
    "ui.you_don_t_need_to_pick_a_categ": "आपको कोई श्रेणी चुनने की आवश्यकता नहीं है - सिविकसाथी आपके लिए उनका सुझाव देता है।",
    "ui.report_progress": "प्रगति रिपोर्ट करें",
    "ui.describe_the_problem": "समस्या का वर्णन करें",
    "ui.describe_the_problem_in_your_o": "समस्या का वर्णन अपने शब्दों में करें...",
    "ui.use_the_example": "उदाहरण का प्रयोग करें",
    "ui.where_is_the_problem": "समस्या कहाँ है?",
    "ui.add_photo_or_evidence": "फ़ोटो या सबूत जोड़ें",
    "ui.civicsathi_will_analyse_your_desc": "सिविकसाथी प्रणालीगत पैटर्न का पता लगाने के लिए आपके विवरण, श्रेणी और स्थान का विश्लेषण करेगा।",
    "ui.edit": "संपादन करना",
    "ui.select_language": "भाषा चुने",
  },
  mr: {
    "ui.issue_mix_in_this_locality": "[HI] Issue mix in this locality",
    "ui.initializing_map": "[HI] Initializing map",
    ...
    "nav.home": "होम",
    "nav.howitworks": "कैपासून चाम करता आहे",
    "nav.map": "नागरिक मानचित्र",
    "nav.report": "समस्या दर्ज करें",
    ...
    "home.hero.badge": "नागरिक पोर्टल",
    "home.hero.title": "जनमाइंड",
    "home.hero.subtitle": "अपने शहर ला बेहतर बनाएं, एक बार मध्ये एक अहवाल।",
    "home.hero.desc":
      "स्थान आणि साक्ष्य चे साथ नागरिक समस्याओं ची अहवाल करें। Civic Sathi व्यक्तिगत शिचायतों ला बड़े पैटर्न पासून जोड़ने मध्ये मदद करता आहे।",
    "home.hero.howitworks": "हा कैपासून चाम करता आहे",
    "home.hero.smallprint":
      "लगभग एक मिनट लगता आहे। तुम्हीला विभाग या श्रेणी जानने ची ज़रूरत नाही — Civic Sathi तुम्हीचे साठी सुझाव देता आहे।",

    "hiw.label": "हा कैपासून चाम करता आहे",
    "hiw.heading": "सड़क ची समस्या पासून नागरिक रिकॉर्ड तक — चार आसान कदम।",
    "hiw.step1.title": "अहवाल",
    "hiw.step1.body": "Civic Sathi ला बताएं क्या हुआ।",
    "hiw.step2.title": "स्थान",
    "hiw.step2.body": "अपना वर्तमान स्थान उपयोग करें या मैन्युअल रूप पासून चुनें।",
    "hiw.step3.title": "प्रमाण",
    "hiw.step3.body": "यदि उपलब्ध हो तो फ़ोटो अपलोड करें।",
    "hiw.step4.title": "ट्रैक करें",
    "hiw.step4.body": "अपनी शिचायत ची प्रगति देखें आणि अपडेट पाएं।",

    "pattern.label": "पैटर्न पहचान",
    "pattern.heading": "एक अहवाल एक शिचायत आहे। कई अहवाल एक पैटर्न आहें।",
    "pattern.desc":
      "जब कई नागरिक पास मध्ये एक जैसी समस्या बताते आहें, तो Civic Sathi उन्हें एक समूह मध्ये जोड़ता आहे — किसी ची पहचान या पता उजागर किए बिना।",
    "pattern.bullet1": "लगभग 500 मीटर मध्ये 23 समान अहवाल",
    "pattern.bullet2": "वार्ड 14 मध्ये 127 संबंधित अहवाल",
    "pattern.bullet3": "चेवल समेकित दृश्य — लाई व्यक्तिगत तपशील साझा नाही",
    "pattern.issues.label": "जो समस्याएं तुम्ही अहवाल कर सकते आहें",
    "pattern.startreport": "अहवाल शुरू करें",

    "stats.label": "नागरिक जानचारी — नमूना डेटा",
    "stats.reports": "वार्ड 14 मध्ये संबंधित अहवाल",
    "stats.types": "समस्या प्रचार",
    "stats.update": "पहला अपडेट औसत समय",
    "stats.cities": "समर्थित शहर",
    ...
    "report.btn.continue": "आगे बढ़ें",
    "report.btn.back": "पीछे",
    "report.btn.submit": "अहवाल जमा करें",

    "register.access": "नागरिक पहुंच",
    "register.heading": "अपना खाता बनाएं",
    "register.subtext": "तुम्हीचा संवर्क तपशील निजी रहता आहे आणि सार्वजनिक मानचित्रों वर नाही दिखाया जाता।",
    "register.name": "पूरा नाव",
    "register.name.placeholder": "तुम्हीचा नाव",
    "register.email": "ईमेल",
    "register.email.placeholder": "तुम्ही@उदाहरण.com",
    "register.phone": "फ़ोन",
    "register.phone.placeholder": "+91 00000 00000",
    "register.password": "पासवर्ड",
    "register.password.placeholder": "कम पासून कम 8 अक्षर",
    "register.password.error": "पासवर्ड कम पासून कम 8 अक्षरों चा होना चाहिए।",
    "register.btn": "खाता बनाएं",
    "register.btn.busy": "खाता बन रहा आहे...",
    "register.success": "खाता बनाया गया",
    "register.error": "अभी तुम्हीचा खाता नाही बनाया जा सचा।",
    "register.existing": "पहले पासून पंजीकृत आहें?",
    "register.signin": "साइन इन करें",

    "login.access": "नागरिक पहुंच",
    "login.heading": "साइन इन करें",
    "login.subtext": "अपनी अहवाल, सूचनाओं आणि शिचायत इतिहास वर वापस जाएं।",
    "login.email": "ईमेल",
    "login.email.placeholder": "तुम्ही@उदाहरण.com",
    "login.password": "पासवर्ड",
    "login.btn": "साइन इन करें",
    "login.btn.busy": "साइन इन हो रहा आहे...",
    "login.success": "साइन इन हो गया",
    "login.error": "साइन इन नाही हो सचा। अपनी जानचारी जांचें।",
    "login.new": "Civic Sathi वर नए आहें?",
    "login.createaccount": "खाता बनाएं",
    ...
    "profile.theme": "थीम वरीयता",
    "btn.save": "बदलाव सहेजें",
    "ui.designation": "पद चा नाव",
    "ui.close_report_details": "अहवाल तपशील बंद करें",
    "ui.similar_reports_within_approxi": "लगभग 500 मीटर चे भीतर इसी तरह ची अहवालें",
    "ui.related_reports": "संबंधित अहवाल",
    "ui.aggregate_view_only_no_citizen": "चेवल समग्र दृश्य - लाई नागरिक पहचान साझा नाही ची जाती आहे।",
    "ui.report_this_too": "मुझे भी इसचा अनुभव आहे",
    "ui.current": "मौजूदा",
    "ui.why_we_ask_for_location": "आम्ही स्थान क्यों पूछते आहें",
    "ui.your_location_helps_us_underst": "तुम्हीचा स्थान आम्हीध्ये स्थानीय नागरिक पैटर्न ला समझने आणि व्यक्तिगत ट्रैकिंग डेटा संग्रहीत किए बिना संबंधित अहवालों ला जोड़ने मध्ये मदद करता आहे।",
    "ui.use_my_current_location": "मेरे वर्तमान स्थान चा उपयोग करें",
    "ui.choose_on_map": "मानचित्र वर चुनें",
    "ui.waiting_for_your_device_locati": "तुम्हीचे डिवाइस स्थान ची प्रतीक्षा ची जा रही आहे...",
    "ui.we_couldn_t_read_your_device_l": "आम्ही तुम्हीचे डिवाइस चा स्थान नाही पढ़ सचे. कृपया मानचित्र वर अपना स्थान चुनें.",
    "ui.location_detected": "स्थान चा पता लगाया गया",
    "ui.tap_the_map_or_drag_the_marker": "सटीक समस्या स्थान पासूनट करने चे साठी मानचित्र वर टैप करें या मार्कर ला खींचें।",
    "ui.add_a_photo_of_the_problem": "समस्या चा फ़ोटो जोड़ें",
    "ui.optional_a_photo_helps_the_dep": "वैकल्पिक रूप पासून एक फोटो विभाग ची मदद करता आहे",
    "ui.camera": "कॅमेरा",
    "ui.gallery": "गॅलरी",
    "ui.replace": "प्रतिस्थापित करें",
    "ui.remove": "निचालना",
    ...
    "ui.detected": "पता चला:",
    "ui.suggested_category": "सुझाई गई श्रेणी:",
    "ui.this_is_an_ai_assisted_suggest": "हा तुम्हीची फोटो वर आधारित AI-सहायता प्राप्त सुझाव आहे। तुम्ही इसची पुष्टि कर सकते आहें या इपासून बदल सकते आहें.",
    "ui.confirm": "पुष्टि करणे",
    "ui.change_category": "श्रेणी बदलें",
    "ui.primary": "प्राथमिक",
    "ui.mobile": "गतिमान",
    "ui.voice_input_not_supported_in_t": "टी मध्ये वॉयस इनपुट समर्थित नाही आहे",
    "ui.listening": "सुनना",
    "ui.processing": "प्रसंस्करण",
    "ui.describe_by_voice": "आवाज पासून वर्णन करें",
    "ui.we_couldn_t_analyze_your_repor": "आम्ही तुम्हीची अहवाल चा विश्लेषण नाही कर सचे",
    "ui.wait_a_moment": "एक पल इंतज़ार करें",
    "ui.similar_issues_found_nearby": "इसी तरह चे मुद्दे आस-पास पाए गए",
    "ui.civicsathi_has_detected_existing_": "सिविकसाथी ने मौजूदा चा पता लगाया आहे",
    "ui.m_away": "एम दूर",
    "ui.other_reports": "अन्य अहवाल",
    "ui.yes_i_m_also_affected": "हां मैं भी प्रभावित हूं",
    "ui.is_your_issue_completely_diffe": "क्या तुम्हीचा मामला बिल्कुल अलग आहे",
    "ui.no_report_as_a_new_issue": "नए मुद्दे चे रूप मध्ये लाई अहवाल नाही",
    "ui.your_report": "तुम्हीची अहवाल",
    "ui.analysis_complete": "विश्लेषण पूरा हुआ",
    "ui.ai_suggested_category": "ऐ सुझाई गई श्रेणी",
    "ui.complaint_received": "शिचायत मिली",
    "ui.your_report_is_now_on_record_a": "तुम्हीची अहवाल अब रिकॉर्ड वर आहे",
    "ui.track_complaint": "शिचायत ट्रैक करें",
    "ui.civicsathi_intelligence": "सिविकसाथी इंटेलिजेंस",
    "ui.analyzing_your_report": "तुम्हीची अहवाल चा विश्लेषण",
    "ui.my_complaints": "मेरी शिचायतें",
    "ui.submitted": "प्रस्तुत केले गया",
    "ui.work_execution_status": "चार्य निष्पादन ची स्थिति",
    "ui.work_progress": "चार्य प्रगति",
    "ui.inspection_passed_work_quality": "निरीक्षण मध्ये चार्य ची गुणवत्ता सही पाई गई",
    "ui.nearby_civic_activity": "आस-पास ची नागरिक गतिविधि",
    "ui.similar_reports_within_500m": "500 मीटर चे भीतर इसी तरह ची अहवाल",
    "ui.timeline": "समय",
    "ui.your_activity": "तुम्हीची गतिविधि",
    "ui.every_report_you_submit_stays_": "तुम्हीचे द्वारा सबमिट ची गई प्रत्येक अहवाल चायम रहती आहे",
    "ui.no_reports_yet": "अभी तक लाई अहवाल नाही",
    "ui.public_civic_intelligence": "पब्लिक सिविक इंटेलिजेंस",
    "ui.by_locality_coloured_by_aggreg": "स्थानीयता पासून, समग्र गंभीरता पासून रंगा हुआ",
    "ui.localities": "जनपद",
    "ui.map_mode": "मानचित्र मोड",
    "ui.search_area_or_locality": "क्षेत्र या इलाचा खोजें...",
    "ui.near_me": "मेरे पास",
    "ui.reset": "रीपासूनट करें",
    "ui.all_issues": "सभी मुद्दे",
    "ui.any_severity": "लाई भी गंभीरता",
    "ui.no_data_under_current_filters": "वर्तमान फ़िल्टर चे अंतर्गत लाई डेटा नाही.",
    "ui.shaded_polygons_are_an_approxi": "छायांकित क्षेत्र एक अनुमानित स्थानिक एकत्रीकरण आहें।",
    "ui.aggregate_view_only_no_names_c": "चेवल समग्र दृश्य - लाई नाव, संवर्क जानचारी या निजी तपशील प्रदर्शित नाही होते आहें।",
    "ui.no_hotspots_under_the_current_": "वर्तमान फ़िल्टर चे अंतर्गत लाई हॉटस्पॉट नाही मिला।",
    "ui.civic_activity": "नागरिक गतिविधि",
    "ui.close_area_details": "क्षेत्र तपशील बंद करें",
    "ui.top_issue": "शीर्ष अंक",
    "ui.recent_activity": "हाल ची गतिविधि",
    "ui.reported": "अहवाल केले गया",
    "ui.no_reports_under_these_filters": "इन फ़िल्टर चे अंतर्गत लाई अहवाल नाही मिली.",
    "ui.approximate_civic_activity_are": "अनुमानित नागरिक गतिविधि क्षेत्र",
    "ui.report_an_issue_here": "हाां किसी समस्या ची अहवाल करें",
    "ui.view_complaints": "शिचायतें देखें",
    "ui.unread": "अपठित ग",
    "ui.updates": "अपडेट",
    "ui.nothing_yet": "अभी तक कुछ भी नाही",
    "auth.sign_in": "दाखिल करणे",
    "ui.preferred_ward": "पसंदीदा वार्ड",
    "ui.notification_settings": "अधिसूचना पासूनटिंग्स",
    "ui.status_updates_on_my_complaint": "मेरी शिचायतों वर स्थिति अद्यतन",
    "ui.nearby_civic_patterns_in_my_wa": "मेरे वार्ड मध्ये निकटवर्ती नागरिक पैटर्न",
    "ui.change_password": "पासवर्ड बदलें",
    "ui.log_out": "लॉग आउट",
    "ui.new_report": "नई अहवाल",
    "ui.tell_civicsathi_what_happened": "सिविकसाथी ला बताएं कि क्या हुआ",
    "ui.you_don_t_need_to_pick_a_categ": "तुम्हीला लाई श्रेणी चुनने ची आवश्यकता नाही आहे - सिविकसाथी तुम्हीचे साठी उनचा सुझाव देता आहे।",
    "ui.report_progress": "प्रगति अहवाल करें",
    "ui.describe_the_problem": "समस्या चा वर्णन करें",
    "ui.describe_the_problem_in_your_o": "समस्या चा वर्णन अपने शब्दों मध्ये करें...",
    "ui.use_the_example": "उदाहरण चा प्रयोग करें",
    "ui.where_is_the_problem": "समस्या कहाँ आहे?",
    "ui.add_photo_or_evidence": "फ़ोटो या सबूत जोड़ें",
    "ui.civicsathi_will_analyse_your_desc": "सिविकसाथी प्रणालीगत पैटर्न चा पता लगाने चे साठी तुम्हीचे तपशील, श्रेणी आणि स्थान चा विश्लेषण करेगा।",
    "ui.edit": "संपादन करणे",
    "ui.select_language": "भाषा चुने",
  },
  ...
  gu: {
    ...
    "ui.civicsathi_municipal_intelligence": "[GU] Civic Sathi Municipal Intelligence Platform",
    "ui.officer_id_email": "[GU] Officer ID / Email",
    "ui.officer_vmc_gov_in": "[GU] officer@vmc.gov.in",
    "ui.password": "પાસવર્ડ",
    "ui.civicsathi_copilot": "[GU] Civic Sathi Copilot",
    ...
    "ui.why_civicsathi_flagged_this": "[GU] Why Civic Sathi Flagged This",
    ...
    "ui.civicsathi_prototype_risk_score": "[GU] Civic Sathi Prototype Risk Score",
    ...
    "ui.review_incoming_complaints_fla": "[GU] Review incoming complaints flagged by Civic Sathi AI as potentially related to existing civic issues.",
    ...
    "ui.patterns_civicsathi_has_detected": "[GU] Patterns Civic Sathi has detected",
    ...
    "ui.civicsathi_civic_infrastructure_p": "[GU] Civic Sathi Civic Infrastructure Platform",
    ...
    "home.hero.desc":
      "સ્થાન અને પુરાવા સાથે નાગરિક સમસ્યાઓની જાણ કરો. Civic Sathi વ્યક્તિગત ફરિયાદોને મોટી પેટર્ન સાથે જોડવામાં મદદ કરે છે.",
    "home.hero.howitworks": "તે કેવી રીતે કામ કરે છે",
    "home.hero.smallprint":
      "લગભગ એક મિનિટ લાગે છે. તમારે વિભાગ કે શ્રેણી જાણવાની જરૂર નથી — Civic Sathi તમારા માટે સૂચવે છે.",

    "hiw.label": "તે કેવી રીતે કામ કરે છે",
    "hiw.heading": "શેરીની સમસ્યાથી નાગરિક રેકોર્ડ સુધી — ચાર સરળ પગલાં.",
    "hiw.step1.title": "રિપોર્ટ",
    "hiw.step1.body": "Civic Sathi ને જણાવો શું થયું.",
    ...
    "pattern.desc":
      "જ્યારે ઘણા નાગરિકો નજીકમાં સમાન સમસ્યા વર્ણવે છે, ત્યારે Civic Sathi તેમને એક જૂથ હૉટસ્પૉટ માં જૂથ કરે છે — કોઈની ઓળખ કે ખાનગી સરનામું જાહેર કર્યા વગર.",
    ...
    "ui.close_report_details": "રિપોર્ટની વિગતો બંધ કરો",
    "ui.similar_reports_within_approxi": "લગભગ 500m ની અંદર સમાન અહેવાલો",
    "ui.related_reports": "સંબંધિત અહેવાલો",
    "ui.aggregate_view_only_no_citizen": "માત્ર એકંદર દૃશ્ય — કોઈ નાગરિક ઓળખ શેર કરવામાં આવી નથી.",
    "ui.report_this_too": "હું પણ આનો અનુભવ કરું છું",
    "ui.current": "વર્તમાન",
    "ui.why_we_ask_for_location": "શા માટે અમે સ્થાન માટે પૂછીએ છીએ",
    "ui.your_location_helps_us_underst": "તમારું સ્થાન અમને સ્થાનિક નાગરિક પેટર્નને સમજવામાં અને વ્યક્તિગત ટ્રેકિંગ ડેટાને સંગ્રહિત કર્યા વિના સંબંધિત અહેવાલોને કનેક્ટ કરવામાં મદદ કરે છે.",
    "ui.use_my_current_location": "મારા વર્તમાન સ્થાનનો ઉપયોગ કરો",
    "ui.choose_on_map": "નકશા પર પસંદ કરો",
    "ui.waiting_for_your_device_locati": "તમારા ઉપકરણ સ્થાનની રાહ જોઈ રહ્યાં છીએ...",
    "ui.we_couldn_t_read_your_device_l": "અમે તમારા ઉપકરણનું સ્થાન વાંચી શક્યાં નથી. કૃપા કરીને નકશા પર તમારું સ્થાન પસંદ કરો.",
    "ui.location_detected": "સ્થાન મળ્યું",
    "ui.tap_the_map_or_drag_the_marker": "ચોક્કસ સમસ્યા સ્થાન સેટ કરવા માટે નકશાને ટેપ કરો અથવા માર્કર ખેંચો.",
    "ui.add_a_photo_of_the_problem": "સમસ્યાનો ફોટો ઉમેરો",
    "ui.optional_a_photo_helps_the_dep": "વૈકલ્પિક ફોટો ડેપને મદદ કરે છે",
    "ui.camera": "કેમેરા",
    "ui.gallery": "ગેલેરી",
    "ui.replace": "બદલો",
    "ui.remove": "દૂર કરો",
    "ui.ai_assisted_image_reading": "AI-આસિસ્ટેડ ઇમેજ રીડિંગ",
    "ui.detected": "શોધાયેલ:",
    "ui.suggested_category": "સૂચિત શ્રેણી:",
    "ui.this_is_an_ai_assisted_suggest": "આ તમારા ફોટાના આધારે AI-આસિસ્ટેડ સૂચન છે. તમે તેને કન્ફર્મ અથવા બદલી શકો છો.",
    "ui.confirm": "પુષ્ટિ કરો",
    "ui.change_category": "કેટેગરી બદલો",
    "ui.primary": "પ્રાથમિક",
    "ui.mobile": "મોબાઈલ",
    "ui.voice_input_not_supported_in_t": "ટી માં વૉઇસ ઇનપુટ સપોર્ટેડ નથી",
    "ui.listening": "શ્રવણ",
    "ui.processing": "પ્રોસેસિંગ",
    "ui.describe_by_voice": "અવાજ દ્વારા વર્ણન કરો",
    "ui.we_couldn_t_analyze_your_repor": "અમે તમારી રિપોર્ટનું વિશ્લેષણ કરી શક્યાં નથી",
    "ui.wait_a_moment": "થોડીવાર રાહ જુઓ",
    "ui.similar_issues_found_nearby": "નજીકમાં સમાન સમસ્યાઓ મળી",
    "ui.civicsathi_has_detected_existing_": "Civic Sathi અસ્તિત્વમાં છે",
    "ui.m_away": "એમ દૂર",
    "ui.other_reports": "અન્ય અહેવાલો",
    "ui.yes_i_m_also_affected": "હા હું પણ પ્રભાવિત છું",
    "ui.is_your_issue_completely_diffe": "શું તમારો મુદ્દો સંપૂર્ણપણે અલગ છે",
    "ui.no_report_as_a_new_issue": "નવી સમસ્યા તરીકે કોઈ રિપોર્ટ નથી",
    "ui.your_report": "તમારો રિપોર્ટ",
    "ui.analysis_complete": "વિશ્લેષણ પૂર્ણ",
    "ui.ai_suggested_category": "Ai સૂચિત શ્રેણી",
    "ui.complaint_received": "ફરિયાદ મળી",
    "ui.your_report_is_now_on_record_a": "તમારો રિપોર્ટ હવે રેકોર્ડ પર છે",
    "ui.track_complaint": "ફરિયાદને ટ્રેક કરો",
    "ui.civicsathi_intelligence": "Civic Sathi બુદ્ધિ",
    "ui.analyzing_your_report": "તમારા અહેવાલનું વિશ્લેષણ",
    "ui.my_complaints": "મારી ફરિયાદો",
    "ui.submitted": "સબમિટ કર્યું",
    "ui.work_execution_status": "કાર્ય અમલની સ્થિતિ",
    "ui.work_progress": "કામમાં પ્રગતિ",
    "ui.inspection_passed_work_quality": "નિરીક્ષણ પસાર કામ ગુણવત્તા",
    "ui.nearby_civic_activity": "નજીકની નાગરિક પ્રવૃત્તિ",
    "ui.similar_reports_within_500m": "500m ની અંદર સમાન અહેવાલો",
    "ui.timeline": "સમયરેખા",
    "ui.your_activity": "તમારી પ્રવૃત્તિ",
    "ui.every_report_you_submit_stays_": "તમે સબમિટ કરો છો તે દરેક રિપોર્ટ રહે છે",
    "ui.no_reports_yet": "હજુ સુધી કોઈ રિપોર્ટ નથી",
    "ui.public_civic_intelligence": "પબ્લિક સિવિક ઇન્ટેલિજન્સ",
    "ui.by_locality_coloured_by_aggreg": "સ્થાનિકતા દ્વારા, એકંદર ગંભીરતા દ્વારા રંગીન",
    "ui.localities": "વિસ્તારો",
    "ui.map_mode": "નકશો મોડ",
    "ui.search_area_or_locality": "વિસ્તાર અથવા વિસ્તાર શોધો...",
    "ui.near_me": "મારી નજીક",
    "ui.reset": "રીસેટ કરો",
    "ui.all_issues": "તમામ મુદ્દાઓ",
    "ui.any_severity": "કોઈપણ ગંભીરતા",
    "ui.no_data_under_current_filters": "વર્તમાન ફિલ્ટર્સ હેઠળ કોઈ ડેટા નથી.",
    "ui.shaded_polygons_are_an_approxi": "શેડવાળા વિસ્તારો અંદાજિત અવકાશી એકત્રીકરણ છે.",
    "ui.aggregate_view_only_no_names_c": "માત્ર એકંદર દૃશ્ય — કોઈ નામ, સંપર્ક માહિતી અથવા ખાનગી વિગતો પ્રદર્શિત થતી નથી.",
    "ui.no_hotspots_under_the_current_": "વર્તમાન ફિલ્ટર્સ હેઠળ કોઈ હોટસ્પોટ મળ્યાં નથી.",
    "ui.civic_activity": "નાગરિક પ્રવૃત્તિ",
    "ui.close_area_details": "વિસ્તારની વિગતો બંધ કરો",
    "ui.top_issue": "ટોચનો મુદ્દો",
    "ui.recent_activity": "તાજેતરની પ્રવૃત્તિ",
    "ui.reported": "જાણ કરી",
    "ui.no_reports_under_these_filters": "આ ફિલ્ટર્સ હેઠળ કોઈ રિપોર્ટ્સ મળ્યા નથી.",
    "ui.approximate_civic_activity_are": "અંદાજિત નાગરિક પ્રવૃત્તિ વિસ્તાર",
    "ui.report_an_issue_here": "અહીં સમસ્યાની જાણ કરો",
    "ui.view_complaints": "ફરિયાદો જુઓ",
    "ui.unread": "ન વાંચેલ",
    "ui.updates": "અપડેટ્સ",
    "ui.nothing_yet": "હજુ સુધી કંઈ નથી",
    "auth.sign_in": "સાઇન ઇન કરો",
    "ui.preferred_ward": "પસંદગીનો વોર્ડ",
    "ui.notification_settings": "સૂચના સેટિંગ્સ",
    "ui.status_updates_on_my_complaint": "મારી ફરિયાદો પર સ્ટેટસ અપડેટ",
    "ui.nearby_civic_patterns_in_my_wa": "મારા વોર્ડમાં નજીકના નાગરિક દાખલાઓ",
    "ui.change_password": "પાસવર્ડ બદલો",
    "ui.log_out": "લોગ આઉટ કરો",
    "ui.new_report": "નવો રિપોર્ટ",
    "ui.tell_civicsathi_what_happened": "Civic Sathi ને કહો કે શું થયું",
    "ui.you_don_t_need_to_pick_a_categ": "તમારે કોઈ શ્રેણી પસંદ કરવાની જરૂર નથી — Civic Sathi તમારા માટે તેમને સૂચવે છે.",
    "ui.report_progress": "પ્રગતિની જાણ કરો",
    "ui.describe_the_problem": "સમસ્યાનું વર્ણન કરો",
    "ui.describe_the_problem_in_your_o": "તમારા પોતાના શબ્દોમાં સમસ્યાનું વર્ણન કરો...",
    "ui.use_the_example": "ઉદાહરણનો ઉપયોગ કરો",
    "ui.where_is_the_problem": "સમસ્યા ક્યાં છે?",
    "ui.add_photo_or_evidence": "ફોટો અથવા પુરાવા ઉમેરો",
    "ui.civicsathi_will_analyse_your_desc": "Civic Sathi સિસ્ટમિક પેટર્ન શોધવા માટે તમારા વર્ણન, શ્રેણી અને સ્થાનનું વિશ્લેષણ કરશે.",
    "ui.edit": "સંપાદિત કરો",
  ...
  kn: {
    ...
    "ui.civicsathi_municipal_intelligence": "[KN] Civic Sathi Municipal Intelligence Platform",
    "ui.officer_id_email": "[KN] Officer ID / Email",
    "ui.officer_vmc_gov_in": "[KN] officer@vmc.gov.in",
    "ui.password": "ಪಾಸ್ವರ್ಡ್",
    "ui.civicsathi_copilot": "[KN] Civic Sathi Copilot",
    ...
    "ui.why_civicsathi_flagged_this": "[KN] Why Civic Sathi Flagged This",
    ...
    "ui.civicsathi_prototype_risk_score": "[KN] Civic Sathi Prototype Risk Score",
    ...
    "ui.review_incoming_complaints_fla": "[KN] Review incoming complaints flagged by Civic Sathi AI as potentially related to existing civic issues.",
    ...
    "ui.patterns_civicsathi_has_detected": "[KN] Patterns Civic Sathi has detected",
    ...
    "ui.civicsathi_civic_infrastructure_p": "[KN] Civic Sathi Civic Infrastructure Platform",
    ...
    "home.hero.desc":
      "ಸ್ಥಳ ಮತ್ತು ಪುರಾವೆಯೊಂದಿಗೆ ನಾಗರಿಕ ಸಮಸ್ಯೆಗಳನ್ನು ವರದಿ ಮಾಡಿ. Civic Sathi ವೈಯಕ್ತಿಕ ದೂರುಗಳನ್ನು ದೊಡ್ಡ ಮಾದರಿಗಳಿಗೆ ಸಂಪರ್ಕಿಸಲು ಸಹಾಯ ಮಾಡುತ್ತದೆ.",
    "home.hero.howitworks": "ಇದು ಹೇಗೆ ಕೆಲಸ ಮಾಡುತ್ತದೆ",
    "home.hero.smallprint":
      "ಸುಮಾರು ಒಂದು ನಿಮಿಷ ತೆಗೆದುಕೊಳ್ಳುತ್ತದೆ. ನೀವು ವಿಭಾಗ ಅಥವಾ ವರ್ಗ ತಿಳಿದಿರಬೇಕಿಲ್ಲ — Civic Sathi ನಿಮಗೆ ಸೂಚಿಸುತ್ತದೆ.",

    "hiw.label": "ಇದು ಹೇಗೆ ಕೆಲಸ ಮಾಡುತ್ತದೆ",
    "hiw.heading": "ನಿಮ್ಮ ಬೀದಿಯ ಸಮಸ್ಯೆಯಿಂದ ನಾಗರಿಕ ದಾಖಲೆಯವರೆಗೆ — ನಾಲ್ಕು ಹಂತಗಳು.",
    "hiw.step1.title": "ವರದಿ",
    "hiw.step1.body": "Civic Sathi ಗೆ ಏನಾಯಿತು ಎಂದು ತಿಳಿಸಿ.",
    ...
    "pattern.desc":
      "ಹಲವಾರು ನಾಗರಿಕರು ಹತ್ತಿರದಲ್ಲಿ ಒಂದೇ ರೀತಿಯ ಸಮಸ್ಯೆಯನ್ನು ವಿವರಿಸಿದಾಗ, Civic Sathi ಅವರನ್ನು ಒಂದು ಹಾಟ್‌ಸ್ಪಾಟ್‌ ಆಗಿ ಗುಂಪು ಮಾಡುತ್ತದೆ — ಯಾರ ಗುರುತು ಅಥವಾ ಖಾಸಗಿ ವಿಳಾಸ ಬಹಿರಂಗಪಡಿಸದೆ.",
    ...
    "login.new": "Civic Sathi ಗೆ ಹೊಸಬರಾ?",
    ...
    "ui.similar_reports_within_approxi": "ಸರಿಸುಮಾರು 500 ಮೀ ಒಳಗೆ ಇದೇ ರೀತಿಯ ವರದಿಗಳು",
    "ui.related_reports": "ಸಂಬಂಧಿತ ವರದಿಗಳು",
    "ui.aggregate_view_only_no_citizen": "ಒಟ್ಟು ವೀಕ್ಷಣೆ ಮಾತ್ರ - ಯಾವುದೇ ನಾಗರಿಕ ಗುರುತನ್ನು ಹಂಚಿಕೊಳ್ಳಲಾಗಿಲ್ಲ.",
    "ui.report_this_too": "ನಾನು ಕೂಡ ಇದನ್ನು ಅನುಭವಿಸುತ್ತೇನೆ",
    "ui.current": "ಪ್ರಸ್ತುತ",
    "ui.why_we_ask_for_location": "ನಾವು ಸ್ಥಳವನ್ನು ಏಕೆ ಕೇಳುತ್ತೇವೆ",
    "ui.your_location_helps_us_underst": "ವೈಯಕ್ತಿಕ ಟ್ರ್ಯಾಕಿಂಗ್ ಡೇಟಾವನ್ನು ಸಂಗ್ರಹಿಸದೆಯೇ ಸ್ಥಳೀಯ ನಾಗರಿಕ ಮಾದರಿಗಳನ್ನು ಅರ್ಥಮಾಡಿಕೊಳ್ಳಲು ಮತ್ತು ಸಂಬಂಧಿತ ವರದಿಗಳನ್ನು ಸಂಪರ್ಕಿಸಲು ನಿಮ್ಮ ಸ್ಥಳವು ನಮಗೆ ಸಹಾಯ ಮಾಡುತ್ತದೆ.",
    "ui.use_my_current_location": "ನನ್ನ ಪ್ರಸ್ತುತ ಸ್ಥಳವನ್ನು ಬಳಸಿ",
    "ui.choose_on_map": "ನಕ್ಷೆಯಲ್ಲಿ ಆಯ್ಕೆಮಾಡಿ",
    "ui.waiting_for_your_device_locati": "ನಿಮ್ಮ ಸಾಧನದ ಸ್ಥಳಕ್ಕಾಗಿ ನಿರೀಕ್ಷಿಸಲಾಗುತ್ತಿದೆ...",
    "ui.we_couldn_t_read_your_device_l": "ನಿಮ್ಮ ಸಾಧನದ ಸ್ಥಳವನ್ನು ನಮಗೆ ಓದಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ನಕ್ಷೆಯಲ್ಲಿ ನಿಮ್ಮ ಸ್ಥಳವನ್ನು ಆಯ್ಕೆಮಾಡಿ.",
    "ui.location_detected": "ಸ್ಥಳ ಪತ್ತೆಯಾಗಿದೆ",
    "ui.tap_the_map_or_drag_the_marker": "ನಿಖರವಾದ ಸಮಸ್ಯೆಯ ಸ್ಥಳವನ್ನು ಹೊಂದಿಸಲು ನಕ್ಷೆಯನ್ನು ಟ್ಯಾಪ್ ಮಾಡಿ ಅಥವಾ ಮಾರ್ಕರ್ ಅನ್ನು ಡ್ರ್ಯಾಗ್ ಮಾಡಿ.",
    "ui.add_a_photo_of_the_problem": "ಸಮಸ್ಯೆಯ ಫೋಟೋ ಸೇರಿಸಿ",
    "ui.optional_a_photo_helps_the_dep": "ಐಚ್ಛಿಕ ಫೋಟೋ ಡೆಪ್‌ಗೆ ಸಹಾಯ ಮಾಡುತ್ತದೆ",
    "ui.camera": "ಕ್ಯಾಮೆರಾ",
    "ui.gallery": "ಗ್ಯಾಲರಿ",
    "ui.replace": "ಬದಲಾಯಿಸಿ",
    "ui.remove": "ತೆಗೆದುಹಾಕಿ",
    "ui.ai_assisted_image_reading": "AI ನೆರವಿನ ಚಿತ್ರ ಓದುವಿಕೆ",
    "ui.detected": "ಪತ್ತೆಹಚ್ಚಲಾಗಿದೆ:",
    "ui.suggested_category": "ಸೂಚಿಸಿದ ವರ್ಗ:",
    "ui.this_is_an_ai_assisted_suggest": "ಇದು ನಿಮ್ಮ ಫೋಟೋವನ್ನು ಆಧರಿಸಿ AI-ಸಹಾಯದ ಸಲಹೆಯಾಗಿದೆ. ನೀವು ಅದನ್ನು ದೃಢೀಕರಿಸಬಹುದು ಅಥವಾ ಬದಲಾಯಿಸಬಹುದು.",
    "ui.confirm": "ದೃಢೀಕರಿಸಿ",
    "ui.change_category": "ವರ್ಗವನ್ನು ಬದಲಾಯಿಸಿ",
    "ui.primary": "ಪ್ರಾಥಮಿಕ",
    "ui.mobile": "ಮೊಬೈಲ್",
    "ui.voice_input_not_supported_in_t": "t ನಲ್ಲಿ ಧ್ವನಿ ಇನ್‌ಪುಟ್ ಬೆಂಬಲಿಸುವುದಿಲ್ಲ",
    "ui.listening": "ಕೇಳುತ್ತಿದೆ",
    "ui.processing": "ಸಂಸ್ಕರಣೆ",
    "ui.describe_by_voice": "ಧ್ವನಿಯ ಮೂಲಕ ವಿವರಿಸಿ",
    "ui.we_couldn_t_analyze_your_repor": "ನಿಮ್ಮ ವರದಿಯನ್ನು ವಿಶ್ಲೇಷಿಸಲು ನಮಗೆ ಸಾಧ್ಯವಾಗಲಿಲ್ಲ",
    "ui.wait_a_moment": "ಸ್ವಲ್ಪ ಕಾಯಿರಿ",
    "ui.similar_issues_found_nearby": "ಇದೇ ರೀತಿಯ ಸಮಸ್ಯೆಗಳು ಸಮೀಪದಲ್ಲಿ ಕಂಡುಬಂದಿವೆ",
    "ui.civicsathi_has_detected_existing_": "Civic Sathi ಅಸ್ತಿತ್ವದಲ್ಲಿರುವುದನ್ನು ಪತ್ತೆ ಮಾಡಿದೆ",
    "ui.m_away": "ಎಂ ದೂರ",
    "ui.other_reports": "ಇತರ ವರದಿಗಳು",
    "ui.yes_i_m_also_affected": "ಹೌದು ನಾನು ಕೂಡ ಪ್ರಭಾವಿತನಾಗಿದ್ದೇನೆ",
    "ui.is_your_issue_completely_diffe": "ನಿಮ್ಮ ಸಮಸ್ಯೆ ಸಂಪೂರ್ಣವಾಗಿ ವಿಭಿನ್ನವಾಗಿದೆಯೇ",
    "ui.no_report_as_a_new_issue": "ಹೊಸ ಸಮಸ್ಯೆಯಾಗಿ ವರದಿ ಇಲ್ಲ",
    "ui.your_report": "ನಿಮ್ಮ ವರದಿ",
    "ui.analysis_complete": "ವಿಶ್ಲೇಷಣೆ ಪೂರ್ಣಗೊಂಡಿದೆ",
    "ui.ai_suggested_category": "Ai ಸೂಚಿಸಿದ ವರ್ಗ",
    "ui.complaint_received": "ದೂರು ಸ್ವೀಕರಿಸಲಾಗಿದೆ",
    "ui.your_report_is_now_on_record_a": "ನಿಮ್ಮ ವರದಿಯು ಈಗ ದಾಖಲೆಯಾಗಿದೆ a",
    "ui.track_complaint": "ದೂರನ್ನು ಟ್ರ್ಯಾಕ್ ಮಾಡಿ",
    "ui.civicsathi_intelligence": "ನಾಗರಿಕ ಸತಿ ಗುಪ್ತಚರ",
    "ui.analyzing_your_report": "ನಿಮ್ಮ ವರದಿಯನ್ನು ವಿಶ್ಲೇಷಿಸಲಾಗುತ್ತಿದೆ",
    "ui.my_complaints": "ನನ್ನ ದೂರುಗಳು",
    "ui.submitted": "ಸಲ್ಲಿಸಲಾಗಿದೆ",
    "ui.work_execution_status": "ಕೆಲಸದ ಅನುಷ್ಠಾನದ ಸ್ಥಿತಿ",
    "ui.work_progress": "ಕೆಲಸದ ಪ್ರಗತಿ",
    "ui.inspection_passed_work_quality": "ಕೆಲಸದ ಗುಣಮಟ್ಟವನ್ನು ಪರಿಶೀಲಿಸಲಾಗಿದೆ",
    "ui.nearby_civic_activity": "ಹತ್ತಿರದ ನಾಗರಿಕ ಚಟುವಟಿಕೆ",
    "ui.similar_reports_within_500m": "500 ಮೀ ಒಳಗೆ ಇದೇ ರೀತಿಯ ವರದಿಗಳು",
    "ui.timeline": "ಟೈಮ್‌ಲೈನ್",
    "ui.your_activity": "ನಿಮ್ಮ ಚಟುವಟಿಕೆ",
    "ui.every_report_you_submit_stays_": "ನೀವು ಸಲ್ಲಿಸುವ ಪ್ರತಿಯೊಂದು ವರದಿಯು ಉಳಿಯುತ್ತದೆ",
    "ui.no_reports_yet": "ಇನ್ನೂ ಯಾವುದೇ ವರದಿಗಳಿಲ್ಲ",
    "ui.public_civic_intelligence": "ಸಾರ್ವಜನಿಕ ಸಿವಿಕ್ ಇಂಟೆಲಿಜೆನ್ಸ್",
    "ui.by_locality_coloured_by_aggreg": "ಸ್ಥಳೀಯತೆಯಿಂದ, ಒಟ್ಟು ತೀವ್ರತೆಯಿಂದ ಬಣ್ಣಿಸಲಾಗಿದೆ",
    "ui.localities": "ಸ್ಥಳಗಳು",
    "ui.map_mode": "ನಕ್ಷೆ ಮೋಡ್",
    "ui.search_area_or_locality": "ಪ್ರದೇಶ ಅಥವಾ ಪ್ರದೇಶವನ್ನು ಹುಡುಕಿ...",
    ...
    "ui.shaded_polygons_are_an_approxi": "ಮಬ್ಬಾದ ಪ್ರದೇಶಗಳು ಅಂದಾಜು ಪ್ರಾದೇಶಿಕ ಒಟ್ಟುಗೂಡಿಸುವಿಕೆಯಾಗಿದೆ.",
    "ui.aggregate_view_only_no_names_c": "ಒಟ್ಟು ವೀಕ್ಷಣೆ ಮಾತ್ರ - ಯಾವುದೇ ಹೆಸರುಗಳು, ಸಂಪರ್ಕ ಮಾಹಿತಿ ಅಥವಾ ಖಾಸಗಿ ವಿವರಗಳನ್ನು ಪ್ರದರ್ಶಿಸಲಾಗುವುದಿಲ್ಲ.",
    "ui.no_hotspots_under_the_current_": "ಪ್ರಸ್ತುತ ಫಿಲ್ಟರ್‌ಗಳ ಅಡಿಯಲ್ಲಿ ಯಾವುದೇ ಹಾಟ್‌ಸ್ಪಾಟ್‌ಗಳು ಕಂಡುಬಂದಿಲ್ಲ.",
    "ui.civic_activity": "ನಾಗರಿಕ ಚಟುವಟಿಕೆ",
    "ui.close_area_details": "ಪ್ರದೇಶದ ವಿವರಗಳನ್ನು ಮುಚ್ಚಿ",
    "ui.top_issue": "ಪ್ರಮುಖ ಸಂಚಿಕೆ",
    "ui.recent_activity": "ಇತ್ತೀಚಿನ ಚಟುವಟಿಕೆ",
    "ui.reported": "ವರದಿಯಾಗಿದೆ",
    "ui.no_reports_under_these_filters": "ಈ ಫಿಲ್ಟರ್‌ಗಳ ಅಡಿಯಲ್ಲಿ ಯಾವುದೇ ವರದಿಗಳು ಕಂಡುಬಂದಿಲ್ಲ.",
    "ui.approximate_civic_activity_are": "ಅಂದಾಜು ನಾಗರಿಕ ಚಟುವಟಿಕೆ ಪ್ರದೇಶ",
    "ui.report_an_issue_here": "ಸಮಸ್ಯೆಯನ್ನು ಇಲ್ಲಿ ವರದಿ ಮಾಡಿ",
    "ui.view_complaints": "ದೂರುಗಳನ್ನು ವೀಕ್ಷಿಸಿ",
    "ui.unread": "ಓದಿಲ್ಲ",
    "ui.updates": "ನವೀಕರಣಗಳು",
    "ui.nothing_yet": "ಇನ್ನೂ ಏನೂ ಇಲ್ಲ",
    "auth.sign_in": "ಸೈನ್ ಇನ್ ಮಾಡಿ",
    "ui.preferred_ward": "ಆದ್ಯತೆಯ ವಾರ್ಡ್",
    "ui.notification_settings": "ಅಧಿಸೂಚನೆ ಸೆಟ್ಟಿಂಗ್‌ಗಳು",
    "ui.status_updates_on_my_complaint": "ನನ್ನ ದೂರುಗಳ ಸ್ಥಿತಿ ನವೀಕರಣಗಳು",
    "ui.nearby_civic_patterns_in_my_wa": "ನನ್ನ ವಾರ್ಡ್‌ನಲ್ಲಿರುವ ಹತ್ತಿರದ ನಾಗರಿಕ ಮಾದರಿಗಳು",
    "ui.change_password": "ಪಾಸ್ವರ್ಡ್ ಬದಲಾಯಿಸಿ",
    "ui.log_out": "ಲಾಗ್ ಔಟ್ ಮಾಡಿ",
    "ui.new_report": "ಹೊಸ ವರದಿ",
    "ui.tell_civicsathi_what_happened": "ಏನಾಯಿತು ಎಂದು ಸಿವಿಕ್‌ಸತಿಗೆ ಹೇಳಿ",
    "ui.you_don_t_need_to_pick_a_categ": "ನೀವು ವರ್ಗವನ್ನು ಆಯ್ಕೆ ಮಾಡುವ ಅಗತ್ಯವಿಲ್ಲ - Civic Sathi ಅವುಗಳನ್ನು ನಿಮಗಾಗಿ ಸೂಚಿಸುತ್ತದೆ.",
    "ui.report_progress": "ಪ್ರಗತಿಯನ್ನು ವರದಿ ಮಾಡಿ",
    "ui.describe_the_problem": "ಸಮಸ್ಯೆಯನ್ನು ವಿವರಿಸಿ",
    "ui.describe_the_problem_in_your_o": "ಸಮಸ್ಯೆಯನ್ನು ನಿಮ್ಮ ಮಾತಿನಲ್ಲಿ ವಿವರಿಸಿ...",
    "ui.use_the_example": "ಉದಾಹರಣೆಯನ್ನು ಬಳಸಿ",
    "ui.where_is_the_problem": "ಸಮಸ್ಯೆ ಎಲ್ಲಿದೆ?",
    "ui.add_photo_or_evidence": "ಫೋಟೋ ಅಥವಾ ಪುರಾವೆಗಳನ್ನು ಸೇರಿಸಿ",
    "ui.civicsathi_will_analyse_your_desc": "Civic Sathi ವ್ಯವಸ್ಥಿತ ಮಾದರಿಗಳನ್ನು ಪತ್ತೆಹಚ್ಚಲು ನಿಮ್ಮ ವಿವರಣೆ, ವರ್ಗ ಮತ್ತು ಸ್ಥಳವನ್ನು ವಿಶ್ಲೇಷಿಸುತ್ತದೆ.",
    "ui.edit": "ಸಂಪಾದಿಸು",
    "ui.select_language": "ಭಾಷೆಯನ್ನು ಆಯ್ಕೆಮಾಡಿ",
  },
};
