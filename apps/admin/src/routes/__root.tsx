...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "CivicSathi Admin" },
      { title: "CivicSathi — Super Admin Platform" },
      ...
      { property: "og:title", content: "CivicSathi — Super Admin Platform" },
