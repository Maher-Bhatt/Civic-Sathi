...
//#region node_modules/.nitro/vite/services/ssr/assets/i18n-CeM6zdEF.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-CpMag0BV.js
...
var styles_default = "/assets/styles-C9mR_TZh.css";
	...
	head: () => ({
		meta: [
			...
			},
			{
				...
				content: "JANMIND Contractor"
			},
			{ title: "JANMIND — Contractor Portal" },
			{
				name: "description",
				content: "JANMIND contractor portal for managing work orders, tenders and performance."
			},
			{
				name: "author",
				content: "JANMIND"
			...
			{
				property: "og:title",
				content: "JANMIND — Contractor Portal"
			},
			{
				property: "og:type",
				content: "website"
...
//#endregion
export { getContractor as a, getWorkOrder as c, submitFieldEvidence as d, updateWorkOrderStatus as f, useContractorAuth as i, getWorkOrders as l, Route as n, getEligibleTenders as o, useI18n as p, Route$2 as r, getTenderDetails as s, router_exports as t, submitBid as u };
