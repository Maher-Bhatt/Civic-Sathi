  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to={"/contractor/dashboard" as any}
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#234A84" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "Civic Sathi Contractor" },
      { title: "Civic Sathi — Contractor Portal" },
      { name: "description", content: "Civic Sathi contractor portal for managing work orders, tenders and performance." },
      { name: "author", content: "Civic Sathi" },
      { property: "og:title", content: "Civic Sathi — Contractor Portal" },
