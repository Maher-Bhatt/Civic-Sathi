...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "CivicSathi Contractor" },
      { title: "CivicSathi — Contractor Portal" },
      { name: "description", content: "CivicSathi contractor portal for managing work orders, tenders and performance." },
      { name: "author", content: "CivicSathi" },
      { property: "og:title", content: "CivicSathi — Contractor Portal" },
