...
import { D as getCivicIssues, c as Route$11 } from "./_ssr/router-D25gp3g4.mjs";
import { n as SectionLabel, t as GlassCard } from "./_ssr/glass-card-CtvEoNHg.mjs";
import { H as ArrowLeft, c as Split, u as ShieldAlert, y as Merge } from "./_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_id-BzxShmbS.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { className: "h-4 w-4" }), "All Civic Issues"]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex flex-wrap items-center gap-3",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Civic Issue Intelligence" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
						...
						className: "p-6",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Issue Summary" }),
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Linked Complaints" })
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-3",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									...
									children: "JN-2026-00001"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-muted-foreground mt-0.5",
									children: "Primary reporter"
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Split, { className: "w-3 h-3" }), " Split"]
								})]
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									...
									className: "text-sm font-medium text-primary hover:underline",
									children: "JN-2026-00002"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-muted-foreground mt-0.5",
									children: "Citizen confirmation"
								})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									onClick: handleSplit,
									className: "text-xs text-muted-foreground hover:text-foreground flex items-center gap-1.5 px-2 py-1 rounded bg-[var(--glass-strong)] transition-colors",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Split, { className: "w-3 h-3" }), " Split"]
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SectionLabel, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Merge, { className: "w-4 h-4" }), " Merge Issue"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-3 text-sm text-muted-foreground",
								children: "If this issue is a duplicate of another Civic Issue, you can merge them together to consolidate impact scores and reports."
							}),
							merging ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: "Merge with another issue"
							})
						]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
						elevation: "raised",
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SectionLabel, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldAlert, { className: "w-4 h-4" }), " Work Execution"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-3 text-sm text-muted-foreground",
								children: "This Civic Issue is ready to be converted into a Work Package for contractors."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								className: "action-btn w-full mt-4 bg-primary text-primary-foreground hover:bg-primary/90",
								children: "Create Work Package"
							})
						]
					})]
				})]
