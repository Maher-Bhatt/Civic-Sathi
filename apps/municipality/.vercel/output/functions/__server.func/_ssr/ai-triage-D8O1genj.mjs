...
//#region node_modules/.nitro/vite/services/ssr/assets/ai-triage-D8O1genj.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "AI Triage Queue"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-muted-foreground",
				children: "Review incoming complaints flagged by JANMIND AI as potentially related to existing civic issues."
			})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Badge, {
				variant: "secondary",
				className: "text-lg py-1 px-4",
				children: [pendingTriage.length, " Pending"]
			})]
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-muted-foreground",
						children: "No pending complaints require human review."
					})
				]
			})
				...
				children: [
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Badge, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TriangleAlert, { className: "h-3 w-3 mr-1" }), " Needs Review"]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "text-xs font-medium text-muted-foreground",
									children: [(item.duplicate_score * 100).toFixed(0), "% Match"]
								})]
							}),
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: "Candidate Civic Issue"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [item.candidate_issue.complaint_count, " existing complaints"] })
									]
								})
							]
						})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardFooter, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							...
							children: [processing === item.complaint.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-4 w-4 animate-spin mr-2" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "h-4 w-4 mr-2" }), "Merge (Duplicate)"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							variant: "outline",
							className: "flex-1 border-destructive text-destructive hover:bg-destructive/10",
							onClick: () => handleAction(item.complaint.id, "reject"),
							disabled: processing === item.complaint.id,
							children: [processing === item.complaint.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-4 w-4 animate-spin mr-2" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "h-4 w-4 mr-2" }), "Split (Unique)"]
						})]
					})
				]
			}, item.analysis_id))
