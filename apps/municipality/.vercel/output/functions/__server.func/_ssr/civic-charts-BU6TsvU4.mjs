...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-charts-BU6TsvU4.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-DX1mcmiS.mjs").then((m) => ({ default: m.CivicMap })));
