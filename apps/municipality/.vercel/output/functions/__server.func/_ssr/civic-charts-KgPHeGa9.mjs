...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-charts-KgPHeGa9.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-Bvy2NM1U.mjs").then((m) => ({ default: m.CivicMap })));
