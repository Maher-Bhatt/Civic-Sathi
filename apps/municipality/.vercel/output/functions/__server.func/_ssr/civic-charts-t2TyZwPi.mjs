...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-charts-t2TyZwPi.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-qWcCpa7p.mjs").then((m) => ({ default: m.CivicMap })));
