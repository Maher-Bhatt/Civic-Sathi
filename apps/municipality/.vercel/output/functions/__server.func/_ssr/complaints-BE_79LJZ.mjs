...
import { B as getSavedViews, I as getMuniComplaints, l as useMuniAuth, s as Route$10, y as bulkUpdateComplaints } from "./router-Cd9GNziQ.mjs";
...
import { D as Funnel, k as Download } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/complaints-BE_79LJZ.js
...
function ComplaintTable({ complaints, selected, onSelect, sortKey, sortDir, onSort }) {
	...
	if (complaints.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			children: "No complaints match the selected filters."
		})
	});
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Complaint Management" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						className: "mt-2 text-2xl font-semibold",
						children: "All civic reports"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-1 text-sm text-muted-foreground",
						children: [sorted.length, " complaints · Prototype Intelligence Data"]
					})
