...
//#region node_modules/.nitro/vite/services/ssr/assets/emerging-issue-card-DZwxnAu3.js
...
function EmergingIssueCard({ issue, className, delay = 0 }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Emerging Systemic Issue" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GlassButton, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					to: "/issues/$id",
					params: { id: issue.id },
					children: ["View Intelligence", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "h-3.5 w-3.5" })]
				})
			})
		]
	});
