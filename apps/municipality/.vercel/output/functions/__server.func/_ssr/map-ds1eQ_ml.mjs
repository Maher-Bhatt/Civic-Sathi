...
import { D as getCivicIssues, l as useMuniAuth } from "./router-Cd9GNziQ.mjs";
import { t as cn } from "./utils-C_uf36nf.mjs";
import { n as SectionLabel, t as GlassCard } from "./glass-card-CtvEoNHg.mjs";
import { D as Funnel, m as RotateCcw } from "../_libs/lucide-react.mjs";
...
import { t as FilterDrawer } from "./filter-drawer-CTln0d3Q.mjs";
import { a as HealthPieChart, i as ClientCivicMap, n as AnimatedStat, r as AreaMiniCharts, t as ActivityTrendChart } from "./civic-charts-O2QBcZrN.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/map-ds1eQ_ml.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Civic Map" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					className: "jm-glitch-text mt-1 text-2xl font-semibold",
					children: "City-wide operational view"
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "7-day pulse" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ActivityTrendChart, {
								data: trendData,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
							elevation: "raised",
							className: "jm-chart-card p-5",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Severity mix" }), healthData.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HealthPieChart, {
								data: healthData,
								className: "h-[160px]"
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-4 text-sm text-muted-foreground",
								children: "No data under filters."
							})]
						}),
						selected ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AreaDetailPanel, {
							...
							className: "p-5",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Map Legend" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-3 text-sm text-muted-foreground",
									children: "Click an area to view operational details, complaint counts, trends and risk scores. Individual complaint locations appear when zoomed in."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-2 text-xs text-subtle",
									children: "Prototype area boundaries — not official ward delimitation."
								})
							]
						})
					]
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Area Details" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
					onClick: onClose,
			...
			area.boundarySource === "derived" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Prototype area boundary"
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				...
				children: [AREA_HEALTH_LABEL[health], " activity"]
			})
		]
	});
}
