...
//#region node_modules/.nitro/vite/services/ssr/assets/createCsrfMiddleware-DL-OnEaz.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-0j0k6a-u.js
var server_0j0k6a_u_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cv2EW9w0.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BQGJ9DUB.mjs").then((n) => n.t),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_0j0k6a_u_exports as t };
