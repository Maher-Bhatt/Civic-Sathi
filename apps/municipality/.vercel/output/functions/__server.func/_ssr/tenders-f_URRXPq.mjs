...
import { Y as listTenders, l as useMuniAuth } from "./router-Cd9GNziQ.mjs";
import { t as cn } from "./utils-C_uf36nf.mjs";
import { n as SectionLabel, t as GlassCard } from "./glass-card-CtvEoNHg.mjs";
import { V as ArrowUpRight, _ as Package, g as Plus } from "../_libs/lucide-react.mjs";
import { r as LoadingState } from "./states-JpTLzdcL.mjs";
import { r as format } from "../_libs/date-fns.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/tenders-f_URRXPq.js
...
function TendersPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Tenders" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "h-4 w-4" }), "Publish Tender"]
			})]
			...
			children: tenders.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Package, { className: "mx-auto h-10 w-10 text-muted-foreground opacity-40" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "No tenders published yet."
				})]
