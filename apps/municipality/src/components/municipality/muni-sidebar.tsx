...
const NAV: NavItem[] = [
  ...
  { to: "/bills", label: "Bills & Approvals", icon: FileText, access: ["Department Head", "Commissioner"] },
  { to: "/disputes", label: "Dispute Resolution", icon: AlertTriangle, access: ["Department Head", "Commissioner"] },
