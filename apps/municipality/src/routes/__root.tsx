...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "CivicSathi Muni" },
      { title: "CivicSathi — Municipality Operations" },
      ...
      { property: "og:title", content: "CivicSathi — Municipal Intelligence" },
