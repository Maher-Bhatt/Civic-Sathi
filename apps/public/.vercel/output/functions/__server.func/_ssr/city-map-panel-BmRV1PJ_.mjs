...
//#region node_modules/.nitro/vite/services/ssr/assets/city-map-panel-BmRV1PJ_.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var CityMap = (0, import_react.lazy)(() => import("./city-map-Ci2Suig_.mjs").then((m) => ({ default: m.CityMap })));
