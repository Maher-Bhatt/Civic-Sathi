...
import { n as CITIES } from "./cities-DkNmkOQx.mjs";
import { D as cn, O as useI18n } from "./router-sgrg9cFt.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/city-map-panel-C-wlN1GQ.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var CityMap = (0, import_react.lazy)(() => import("./city-map-DGG99P3N.mjs").then((m) => ({ default: m.CityMap })));
