...
//#region node_modules/.nitro/vite/services/ssr/assets/city-map-panel-D5QmpsxM.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var CityMap = (0, import_react.lazy)(() => import("./city-map-HOmqop6L.mjs").then((m) => ({ default: m.CityMap })));
