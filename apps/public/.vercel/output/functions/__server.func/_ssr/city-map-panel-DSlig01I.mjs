...
//#region node_modules/.nitro/vite/services/ssr/assets/city-map-panel-DSlig01I.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var CityMap = (0, import_react.lazy)(() => import("./city-map-z0Z3ba1b.mjs").then((m) => ({ default: m.CityMap })));
