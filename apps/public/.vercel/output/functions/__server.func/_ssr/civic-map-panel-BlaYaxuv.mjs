...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-map-panel-BlaYaxuv.js
...
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-BFo9mHUJ.mjs").then((m) => ({ default: m.CivicMap })));
