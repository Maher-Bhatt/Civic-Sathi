...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-map-panel-BpR_xYXg.js
...
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-pOYrsSlE.mjs").then((m) => ({ default: m.CivicMap })));
