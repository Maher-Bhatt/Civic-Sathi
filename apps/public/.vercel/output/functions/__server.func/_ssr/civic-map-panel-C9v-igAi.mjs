...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-map-panel-C9v-igAi.js
...
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-A1nZYdjg.mjs").then((m) => ({ default: m.CivicMap })));
