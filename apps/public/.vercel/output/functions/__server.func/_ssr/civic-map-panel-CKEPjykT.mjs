...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-map-panel-CKEPjykT.js
...
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-CFPsDwgN.mjs").then((m) => ({ default: m.CivicMap })));
