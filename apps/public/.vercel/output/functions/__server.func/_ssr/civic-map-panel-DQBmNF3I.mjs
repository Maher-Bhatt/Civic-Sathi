...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-map-panel-DQBmNF3I.js
...
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-DPS9JkUT.mjs").then((m) => ({ default: m.CivicMap })));
