...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-map-panel-DkyQwpSP.js
...
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-BC7Vllk8.mjs").then((m) => ({ default: m.CivicMap })));
