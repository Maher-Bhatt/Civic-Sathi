...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-map-panel-GXeabTLk.js
...
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-CB9kbVA-.mjs").then((m) => ({ default: m.CivicMap })));
