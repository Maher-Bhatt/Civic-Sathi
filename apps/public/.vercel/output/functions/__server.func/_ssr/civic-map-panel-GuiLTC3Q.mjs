...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-map-panel-GuiLTC3Q.js
...
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-DHdjoJNC.mjs").then((m) => ({ default: m.CivicMap })));
