...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-map-panel-NLEeD7DR.js
...
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-BJ-0V63m.mjs").then((m) => ({ default: m.CivicMap })));
