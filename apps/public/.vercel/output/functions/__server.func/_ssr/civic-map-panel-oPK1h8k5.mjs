...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-map-panel-oPK1h8k5.js
...
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-CHbUOkMF.mjs").then((m) => ({ default: m.CivicMap })));
