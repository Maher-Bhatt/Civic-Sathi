...
//#region node_modules/.nitro/vite/services/ssr/assets/civic-map-panel-poeOiiJs.js
...
var CivicMap = (0, import_react.lazy)(() => import("./civic-map-B-1-1a1j.mjs").then((m) => ({ default: m.CivicMap })));
