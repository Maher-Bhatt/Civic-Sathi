...
import { D as useI18n, c as GlassButton, d as SectionLabel, l as GlassCard, u as PageShell, w as useAuth } from "./router-BhIDCrT5.mjs";
import { r as Route$6 } from "./router-BhIDCrT52.mjs";
import { t as GlassInput } from "./glass-input-C05CvLHo.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-BKIQIFdI.js
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: "Verified Citizen Account"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "block text-[11px] text-[var(--muted-foreground)] font-mono",
								children: "citizen@janmind.in"
							})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-[11px] px-2 py-0.5 rounded bg-primary/15 text-primary font-medium",
