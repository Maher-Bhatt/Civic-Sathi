...
import { F as Crosshair, K as ArrowUpRight, O as Info, d as ShieldCheck, f as Search, o as TrendingUp, p as RotateCcw, s as TrendingDown, t as X } from "../_libs/lucide-react.mjs";
import { g as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as PageShell, n as GlassButton, o as SectionLabel, r as GlassCard } from "./glass-card-BssLVty0.mjs";
import { n as CITIES, o as getCity, s as nearestCity } from "./cities-DkNmkOQx.mjs";
import { _ as complaintPoints, a as DEFAULT_FILTERS, b as searchAreas, c as TIME_WINDOWS, f as cityDailyTrend, h as cityIssueBreakdown, i as ClientCivicMap, l as areaActivity, m as cityHealthDistribution, n as AREA_HEALTH_LABEL, o as ISSUE_KEYS, p as cityGeography, r as AREA_HEALTH_ORDER, s as ISSUE_LABEL, t as AREA_HEALTH_HEX, u as areaDailyTrend, v as filterPoints, y as nearestArea } from "./civic-map-panel-DQBmNF3I.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/map-COpgqDzF.js
...
function CivicMapPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PageShell, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Public civic intelligence" }),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [getCity(cityId).name, " by locality, coloured by aggregate civic activity. Open an area to see its health, the issues driving it and recent momentum."]
				})
			]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [CITIES.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: cn("press rounded-full border px-3.5 py-1.5 text-xs tracking-[0.08em] uppercase transition-all duration-200", cityId === c.id ? "border-[color-mix(in_oklab,var(--primary)_45%,transparent)] bg-[color-mix(in_oklab,var(--primary)_16%,transparent)] text-foreground" : "border-[var(--glass-border)] bg-[var(--glass)] text-muted-foreground hover:-translate-y-0.5 hover:text-foreground"),
						children: c.name
					}, c.id)), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "text-[0.66rem] tracking-[0.08em] text-subtle uppercase",
						children: [geography.areas.length, " localities"]
					})]
				}),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "7-day activity pulse" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ActivityTrendChart, {
								data: trendData,
								className: "mt-2"
							})]
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Issue breakdown" }), issueData.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(IssueBreakdownChart, {
								data: issueData,
								className: "mt-2"
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-6 text-sm text-muted-foreground",
								children: "No data under current filters."
							})]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Info, {
							...
							"aria-hidden": true
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [geography.dataNote, " Shaded polygons are an “Approximate Civic Activity Area”, not an official municipal boundary. Prototype activity data."] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "flex items-start gap-2 text-xs text-subtle",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, {
							className: "mt-0.5 h-3.5 w-3.5 shrink-0",
							"aria-hidden": true
						}), "Aggregate view only — no names, contacts, private addresses or exact report locations are published."]
					})
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "Severity distribution" }), healthData.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HealthPieChart, { data: healthData }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: mode === "hotspots" ? "Active hotspots" : "Most active areas" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
						...
						children: [(mode === "hotspots" ? hotspots : ranked.slice(0, 10)).map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: "No hotspots under the current filters."
						})]
					})]
				})]
			})]
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: [AREA_HEALTH_LABEL[activity.health], " civic activity"]
							}),
						...
						children: [activity.recent.map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									...
									children: [ISSUE_LABEL[r.issue], " reported"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							className: "text-sm text-muted-foreground",
							children: "No reports under these filters."
						})]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-[0.68rem] leading-relaxed text-subtle",
					children: "Approximate Civic Activity Area — derived catchment, not an official municipal boundary. Aggregate counts only; no citizen identity or address is shown."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GlassButton, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: "/report",
							children: ["Report an issue here", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, {
								className: "h-3.5 w-3.5",
								"aria-hidden": true
							})]
						})
