...
import { D as Inbox, F as CirclePlus, M as FileText, S as Map, U as Bell, a as TriangleAlert, j as Globe, k as House, n as User, t as X, u as Smartphone, w as LoaderCircle, x as Menu, z as Check } from "../_libs/lucide-react.mjs";
import { g as Link, l as useRouterState, v as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { t as Slot } from "../_libs/radix-ui__react-slot.mjs";
import { a as router_exports } from "./router-DYLopdf12.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/glass-card-R3hZ17S1.js
...
function InstallPwaButton({ className = "" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			className: `inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 border border-primary/30 bg-primary/10 text-primary hover:bg-primary/20 hover:border-primary/50 shadow-sm hover:shadow active:scale-95 ${className}`,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Smartphone, { className: "w-3.5 h-3.5 text-primary animate-pulse" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "📲 Install Android App" })]
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/require-auth-Xbh57BXw.js
