			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, {
						elevation: "raised",
						className: "overflow-hidden p-3.5 space-y-2.5",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center justify-between gap-2 px-1 pb-1",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center gap-1.5 p-1 rounded-xl bg-[var(--surface)] border border-[var(--glass-border)]",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										onClick: () => handleCitySelect("vadodara"),
										className: `px-3 py-1 rounded-lg text-xs font-semibold transition-all ${cityId === "vadodara" ? "bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
										children: "Vadodara (VMC)"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										onClick: () => handleCitySelect("bengaluru"),
										className: `px-3 py-1 rounded-lg text-xs font-semibold transition-all ${cityId === "bengaluru" ? "bg-blue-500/20 text-blue-300 border border-blue-500/40 shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
										children: "Bengaluru (BBMP)"
									})]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-[10px] text-muted-foreground",
									children: cityId === "vadodara" ? "24 Areas · 12k Reports" : "35 Areas · 100k Reports"
								})]
							}),
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center justify-between gap-3 px-1.5 pt-1 pb-0.5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-[0.68rem] tracking-[0.08em] text-subtle uppercase",
									children: cityId === "vadodara" ? "Vadodara Live Catchment" : "Bengaluru Live Catchment"
