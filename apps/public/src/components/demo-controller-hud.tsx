...
const DEMO_STEPS = [
  {
    step: 1,
    title: "AI Smart Composer",
    route: "/submit",
    badge: "1. Intake",
    description: "Multi-department AI triage & decomposition",
  },
  {
    step: 2,
    ...
    badge: "2. Passport",
    description: "Official seal, dependency locks & predictive risk",
  },
  {
    step: 3,
    ...
    badge: "3. Systems",
    description: "6 sovereign platforms, pings & CDM mappings",
  },
  {
    step: 4,
    ...
    badge: "4. Transit",
    description: "Animated packet flows & auto dependency handoff",
  },
  {
    step: 5,
    ...
    badge: "5. Command",
    description: "27 Corporations Digital Twin & ₹4.82 Cr savings",
  },
  {
    step: 6,
    title: "DEPA Citizen Consent",
    route: "/consent",
    badge: "6. Consent",
    description: "DPDP Act 2023 compliant data governance",
  },
  {
    step: 7,
    title: "MDM Exception Queue",
    route: "/exceptions",
    badge: "7. MDM",
