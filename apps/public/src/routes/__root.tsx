...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "CivicSathi" },
      { title: "CivicSathi — Citizen Civic Intelligence" },
      { name: "description", content: "Report civic problems with location and evidence. CivicSathi connects individual complaints into larger patterns." },
      { name: "author", content: "CivicSathi" },
      { property: "og:title", content: "CivicSathi — Civic Grievance Intelligence" },
      { property: "og:description", content: "Report civic problems with location and evidence. CivicSathi connects individual complaints into larger patterns." },
