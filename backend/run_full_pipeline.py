"""
Run JANMIND Full Dataset ML Pipeline
...
def main():
    ...
    print_header("JANMIND FULL DATASET ML PIPELINE")
    ...
    try:
        ...
        print("⚠️  WARNING: This will process all 766,648 records.")
        print("   Estimated time: 2-3 hours")
        print("   The process will:")
        print("   - Load and preprocess all data")
        print("   - Generate 766K semantic embeddings")
        print("   - Perform clustering")
        print("   - Analyze temporal patterns")
        print("   - Score risks")
        print("   - Detect systemic issues")
        print("   - Generate root causes")
